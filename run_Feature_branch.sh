...
WIDTH=640
HEIGHT=480
L_DIM=384  # small-model: 64; middle-model: 128; large-model: 384
M_DIM=256  # small-model: 64; middle-model: 128; large-model: 256
H_DIM=512  # small-model: 64; middle-model: 128; large-model: 512
